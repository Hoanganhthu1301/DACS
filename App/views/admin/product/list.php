...
<div class="container mt-4">
    ...
    <a href="/DACS/Product/add" class="btn btn-success mb-2">🍅 Thêm sản phẩm mới 🍅</a>
            ...
            <div class="col-md-4 mb-4">
                <div class="card shadow-sm">
                    <?php if (!empty($product->image) && file_exists('uploads/' . $product->image)): ?>
                        <img src="/DACS/uploads/<?php echo $product->image; ?>" class="card-img-top" alt="Product Image" style="height: 200px; object-fit: cover;">
                    <?php else: ?>
                        <img src="https://via.placeholder.com/300" class="card-img-top" alt="Default Image" style="height: 200px; object-fit: cover;">
                    <?php endif; ?>
                    <div class="card-body">
                        <h5 class="card-title">
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="/DACS/Product/edit/<?php echo $product->id; ?>" class="btn btn-warning btn-sm">Sửa</a>
                            <a href="/DACS/Product/delete/<?php echo $product->id; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Bạn có chắc chắn muốn xóa sản phẩm này?');">Xóa</a>
