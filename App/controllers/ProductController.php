...
require_once('app/helpers/auth.php'); // 🔥 THÊM DÒNG NÀY
...
class ProductController {
    ...
    public function show($id)
    {
        ...
        // Nếu có sản phẩm thì mới hiển thị view show.php
        include 'app/views/product/show.php';
    }
    


    // 🔒 Chỉ admin mới được add sản phẩm
    public function add() {
        if (!isAdmin()) {
    ...
    public function update() {
        if (!isAdmin()) {
            echo "Bạn không có quyền chỉnh sửa sản phẩm.";
            exit;
        }
